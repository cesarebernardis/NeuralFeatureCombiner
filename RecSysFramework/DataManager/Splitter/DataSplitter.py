...
class DataSplitter(object):
    ...
    def __init__(self, with_validation=True, allow_cold_users=False):
    ...
    def load_split(self, datareader, save_folder_path=None, postprocessings=None, filename_suffix=""):
        ...
        if not tmp_save_folder_path.endswith(os.sep):
            tmp_save_folder_path += os.sep
