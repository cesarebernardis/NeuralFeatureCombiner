...
cdef class CFW_D_Similarity_Cython_SGD:
    ...
    def run_tests(self):
        ...
        self.common_features_data = np.zeros((n_test_features), dtype=np.float32)
        self.common_features_data_i = np.zeros((n_test_features), dtype=np.float32)
    ...
    def precompute_common_features_function(self, ICM):
        ...
        self.commonFeatures_data = commonFeatures.data
    ...
    def fit(self):
        ...
        return sqrt(cum_loss) / sample_num
